...
routerHome.get("/laptop-office", controllerHome.laptopOffice);
...
routerHome.post(
  ...
  controllerHome.editUser
);
routerHome.post(
  "/deleteuser",
  authMiddleware.isAuthAdmin,
  controllerHome.deleteUser
);
routerHome.get(
  "/editproduct/:id",
  authMiddleware.isAuthAdmin,
  controllerHome.editProduct
);
routerHome.post(
  "/editproduct",
  uploadMuti,
  authMiddleware.isAuthAdmin,
  controllerHome.editProductPost
);
routerHome.post(
  "/deleteproduct",
  authMiddleware.isAuthAdmin,
  controllerHome.deleteProduct
);
...
routerHome.post(
  "/order-management",
  authMiddleware.isAuthAdmin,
  controllerHome.orderManagement
);
routerHome.post(
  "/order-management/update/:id",
  authMiddleware.isAuthAdmin,
  controllerHome.updateOrder
);
routerHome.get(
  "/order-success/:id",
  authMiddleware.isAuthAdmin,
  controllerHome.orderSuccess
);
routerHome.get(
  "/order-reject/:id",
  authMiddleware.isAuthAdmin,
  controllerHome.orderReject
);
routerHome.get(
  "/order-shipping/:id",
  authMiddleware.isAuthAdmin,
  controllerHome.orderShipping
);
routerHome.get(
  "/order-shipped/:id",
  authMiddleware.isAuthAdmin,
  controllerHome.orderShipped
);
routerHome.post(
  "/deleteorder",
  authMiddleware.isAuthAdmin,
  controllerHome.deleteOrder
);
routerHome.post(
  "/get-orderdetails/:id",
  authMiddleware.isAuth,
  controllerHome.orderDetails
);
routerHome.post("/reviews/:id", authMiddleware.isAuth, controllerHome.reviews);
routerHome.get(
  "/reviews-management",
  authMiddleware.isAuthAdmin,
  controllerHome.reviewsManagement
);
routerHome.get(
  "/reviews-management-by-product/:id",
  authMiddleware.isAuthAdmin,
  controllerHome.reviewsManagementByProduct
);
routerHome.get(
  "/deletereview/:id",
  authMiddleware.isAuthAdmin,
  controllerHome.deleteReviews
);
routerHome.put(
  "/update-order-is-rated/:id",
  authMiddleware.isAuth,
  controllerHome.updateOrderIsRated
);
